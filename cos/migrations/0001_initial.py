    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_status', models.CharField(blank=True, choices=[('audited', 'Audited'), ('audited_old', 'Audited Old'), ('needs_audit', 'Needs Audit'), ('missing_info', 'Need More Info')], max_length=200)),
